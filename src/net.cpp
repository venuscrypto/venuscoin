...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Venuscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"venuscoins.info", "35.227.90.84"},
    {"miner1.venuscrypto.org", "104.196.191.28"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"venuscointools.com", "testnet-seed.venuscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Venuscoin is probably already running."), addrBind.ToString().c_str());
        else
